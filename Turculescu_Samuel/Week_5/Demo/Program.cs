...
namespace Demo
{
    class Program
    {
        static async Task Main(string[] args)
        {
           ...
           //Adding a Restaurant
                    var exprRestaurant =
                        from restaurantResult in RestaurantDomain.CreateRestaurantAndPersist("Restaurant_7", "address")
                        let r = (restaurantResult as RestaurantCreated)?.Restaurant
        ...
        private static bool OnRestaurantNotFound(GetRestaurantResult.RestaurantNotFound arg)
        {
            return false;
        }
