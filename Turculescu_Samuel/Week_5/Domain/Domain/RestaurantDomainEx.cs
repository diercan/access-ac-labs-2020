...
namespace Domain.Domain
{
    public static class RestaurantDomainEx
    {
        ...
        public static IO<IList<Menu>> GetMenus(Restaurant restaurant)
        ...
        // Create a MenuItem
        public static IO<MenuItemAgg> CreateMenuItemAndPersist(Menu menu, string name, string ingredients, string allergens, uint totalQuantity, double price, bool availability)
        ...
        public static IO<OrderAgg> PlaceOrderAndPersist(Client client, Restaurant restaurant, double totalPrice, uint tableNumber)
        ...
        public static IO<IList<Order>> GetOrders(Restaurant restaurant)
