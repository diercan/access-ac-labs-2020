...
namespace Domain.Domain
{
    public static class RestaurantDomain
    {
        ...
        // EMPLOYEE
        public static IO<ICreateEmployeeResult> CreateEmployee(string firstName, string lastName, string email, string phone, string employeeId, Restaurant restaurant) =>
            NewIO<CreateEmployeeCmd, ICreateEmployeeResult>(new CreateEmployeeCmd(firstName, lastName, email, phone, employeeId, restaurant));

        public static IO<GetEmployeeResult.IGetEmployeeResult> GetEmployee(Restaurant restaurant, string employeeId) =>
        ...
        // CLIENT
        public static IO<ICreateClientResult> CreateClient(string firstName, string lastName, string email, string phone, string cardNumber, string clientId) =>
        ...
        public static IO<GetMenusResult.IGetMenusResult> GetMenu(Restaurant restaurant) =>
        ...
        public static IO<PlaceOrderResult.IPlaceOrderResult> PlaceOrder(Client client, Restaurant restaurant, Cart cart, uint tableNumber) =>
