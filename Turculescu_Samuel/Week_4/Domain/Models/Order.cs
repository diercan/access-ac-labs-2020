...
namespace Domain.Models
{
    ...
    public class Order
    {
        ...
        public Order(uint orderId, int clientId, uint tableNumber, OrderStatus orderStatus = OrderStatus.Processing, PaymentStatus paymentStatus = PaymentStatus.Processing)
        {
            OrderId = orderId;
            ClientId = clientId;
